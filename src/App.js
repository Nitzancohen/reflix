        ...
        <Router>
          <div>
            <div>
              ...
              <span className="App-link" id="logo">REFLIX</span>
            </div>
            <br />
            <hr />
            <Route exact path="/" component={Landing} />
            <Route exact path="/catalog" render={({ match }) => <Catalog match={match} state={state} rent={this.rent} />} />
            <Route exact path="/movies/:id" render={({ match }) => <MovieDetail match={match} state={state} />} />
          </div>
        </Router>
      </div>
    );
